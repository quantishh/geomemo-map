...
export default function handler(req, res) {
  ...
  const title = `${countryName} Intelligence Brief | GeoMemo Monitor`;
...
<head>
  ...
  <meta property="og:site_name" content="GeoMemo Monitor"/>

  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:site" content="@GeoMemoNews"/>
